...
\fancyhead{} % Rimuove il titolo del capitolo dalle intestazioni
...
\title{
    ...
    \vspace{0.5cm} 
    \Large{Ingegneria Informatica Magistrale}
}
\author{\textbf{Agostino D'Amora}} % Modifica con il tuo nome
\date{\today}
